...
routes.get('/complaints', corsMiddleware.manualCors, passportMiddleware.authenticate('cookie', {
  session: false
}), rolesMiddleware.grantAccess('readAny', 'comment'), commentController.getCommentsWithComplaints);
routes.get('/:announce_id', corsMiddleware.manualCors, passportMiddleware.authenticate('cookie', {
  session: false
}), rolesMiddleware.grantAccess('readAny', 'comment'), commentController.getCommentsByAnnounce);
...
routes.put('/disable/:comment_id', corsMiddleware.manualCors, passportMiddleware.authenticate('cookie', {
  session: false
}), commentController.disableComment);
routes.options('/enable/:comment_id', cors(corsMiddleware.authedCors)); // enable pre-flights

routes.put('/enable/:comment_id', corsMiddleware.manualCors, passportMiddleware.authenticate('cookie', {
  session: false
}), commentController.enableComment);
routes.options('/like/:comment_id', cors(corsMiddleware.authedCors)); // enable pre-flights

routes.put('/like/:comment_id', corsMiddleware.manualCors, passportMiddleware.authenticate('cookie', {
  session: false
}), commentController.createCommentLike);
routes.options('/unlike/:comment_id', cors(corsMiddleware.authedCors)); // enable pre-flights

routes.put('/unlike/:comment_id/:likeIndex', corsMiddleware.manualCors, passportMiddleware.authenticate('cookie', {
  session: false
}), commentController.removeCommentLike);
routes.options('/response', cors(corsMiddleware.authedCors)); // enable pre-flights

routes.post('/response', corsMiddleware.manualCors, passportMiddleware.authenticate('cookie', {
  session: false
...
routes.put('/response/like/:comment_id/:responseIndex', corsMiddleware.manualCors, passportMiddleware.authenticate('cookie', {
  session: false
...
routes.put('/response/unlike/:comment_id/:responseIndex/:likeIndex', corsMiddleware.manualCors, passportMiddleware.authenticate('cookie', {
  session: false
}), commentController.removeCommentResponseLike);
routes.options('/:comment_id', cors(corsMiddleware.authedCors)); // enable pre-flights

routes["delete"]('/:comment_id', corsMiddleware.manualCors, passportMiddleware.authenticate('cookie', {
  session: false
}), commentController.removeComment);
routes.options('/complaints/:comment_id', cors(corsMiddleware.authedCors)); // enable pre-flights

routes.put('/complaints/:comment_id', corsMiddleware.manualCors, passportMiddleware.authenticate('cookie', {
  session: false
