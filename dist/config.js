...
require('dotenv').config(); // eslint-disable-next-line no-undef


var processEnv = process.env;
var env = processEnv.NODE_ENV || 'production';
var isProd = env === 'production';
var frontend = isProd ? 'https://kargain.com' : 'http://localhost:3000';
var db = {
...
module.exports = {
  ...
  db: db,
  api_path: '/v1',
  whileListDomains: ['http://localhost:8080', 'http://localhost:3000', 'http://localhost:5000', 'https://kargain.com', 'https://api.kargain.com', 'https://kargain-api-nine.vercel.app', 'https://kargain-api.kargainworld.vercel.app/', 'https://kargain-app.kargainworld.vercel.app'],
  externalsAPI: {
    vindecoderFree: {
